...
// Ajustes de robustez
const FILTRO_FRAMES = 8; // Más frames para confirmar detección
let historialDeteccion = [];
let ultimaSenalConfirmada = null;

// Configuración del modelo
const MODEL_CONFIG = {
  threshold: 0.85, // Umbral de confianza más alto
...
const MIN_DIFERENCIA = 0.5; // Diferencia mínima más alta
